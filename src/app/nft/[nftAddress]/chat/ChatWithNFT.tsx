...
const ChatWithNft = ({
  ...
  return (
    <div ref={ref}>
      <div className="chat-messages mx-auto max-w-4xl w-full mt-20 min-h-[calc(100dvh-200px)] md:min-h-[calc(100dvh-84px)] px-6 sm:px-0 pb-40">
